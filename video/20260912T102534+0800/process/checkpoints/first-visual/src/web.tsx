  ...
  return (
    <>
      <header className="site-header shell">
        ...
        <div className="site-controls" aria-label={zh ? "旁白语言" : "Narration language"}>
      ...
      <main className="shell">
        <section className="site-intro">
          ...
          <div className="site-intro-copy">
            ...
            <span>01:49 · 1920 × 1080 · {zh ? "中文配音" : "ENGLISH NARRATION"}</span>
          </div>
        </section>
            ...
            {story.scenes.map((scene, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <em>
                    {Math.floor(timing.scenes[index].start / timing.fps / 60)}:
                    {String(Math.floor(timing.scenes[index].start / timing.fps) % 60).padStart(
                      2,
                      "0",
                    )}
                  </em>
