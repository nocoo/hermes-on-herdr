...
def spoken(text):
    ...
    for name, pronunciation in (("Herdr", "Herder"), ("Hexly AI", "Hexly A.I."),
                                ("M2", "M two"), ("TUI", "T U I"),
                                ("SSH", "S S H"), ("VPN", "V P N")):
...
def timeline():
    ...
    # The user approved the film with subtitle-free opening and closing plates.
    # Keep their narration/timing, but omit their cues from downloadable/embedded captions.
    subtitles = [c for c in result["captions"] if c["scene"] not in ("intro", "outro")]
